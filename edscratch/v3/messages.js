...
Blockly.Msg.MENU_DROP_LANGUAGE_LABEL = "言語"; //navPopLanguage
...
Blockly.Msg.MODAL_LANGUAGE = "Language"; //divLanguageLabel
...
Blockly.Msg.MODAL_DIAGNOSTICS_FIRMWARE_TITLE = "Fix firmware"; //divDiagnosticsFirmwareLabel
Blockly.Msg.MODAL_DIAGNOSTICS_FIRMWARE_BODY = "If Edison V3 isn't behaving as expected, it might be a firmware issue. Click Fix firmware to push a firmware update."; //divDiagnosticsFirmwareBody
Blockly.Msg.MODAL_DIAGNOSTICS_FIRMWARE_BUTTON = "Fix firmware"; //navPopHelpGetStatus
...
Blockly.Msg.MODAL_STATUS_TITLE = "Fix firmware"; //divFirmwareStatusLabel
...
Blockly.Msg.MODAL_STATUS_FIRMWARE_UPDATE_BUTTON = "Force firmware update";
...
Blockly.Msg.MODAL_PROGRAMING_FIRMWARE_UPDATED_NOW_PROGRAMMING = "Now programming Edison...";
...
Blockly.Msg.ERROR_YELLOW_SET_MOTOR_RIGHT = "「〜で右モーターを〜設定にする」は右モーターの回転方向を設定するだけです。動かすためには他のブロックを追加で接続してください。";
